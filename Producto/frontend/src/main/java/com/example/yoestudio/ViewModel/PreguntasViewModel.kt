...
import com.example.yoestudio.Data.Network.Usuario
...
class PreguntasViewModel: ViewModel() {
    ...
    fun agregarPregunta(idUsuario: Long, pregunta: String, respuesta: String) {
    ...
    fun cargarPreguntas(usuarioId: Long) {

        viewModelScope.launch {

            try {
                preguntasUsuario =
                    ApiNet.apiPreguntas.obtenerPorUsuario(usuarioId)
